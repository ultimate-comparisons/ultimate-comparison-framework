...
gulp.task('development-column', function (done) {
    ...
    writeFileSync(paths.assets + '/comparison.yml', yaml2json.safeDump(yaml), 'utf8');
    done();
});

gulp.task('build-data', gulp.series('markdown', 'criteria', 'determineColors', 'citation', 'assets', 'development-column'));
// --------------------------------------------------------------->
