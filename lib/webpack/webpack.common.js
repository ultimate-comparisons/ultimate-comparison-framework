...
module.exports = {
    ...
    "plugins": [
        ...
        new CopyWebpackPlugin([
            {
                "from": path.join(projectRoot, "src/assets/comparison.yml"),
            },
            {
                "from": path.join(projectRoot, "src/assets/data.json"),
            },
            {
                "from": path.join(projectRoot, "src/assets/bootstrap.min.css"),
            },
            {
                "from": path.join(projectRoot, "src/assets/style.css"),
            },
            {
        ...
        new AngularCompilerPlugin({
            ...
            "sourceMap": true,
            "tsConfigPath": path.join(projectRoot, "src/tsconfig.app.json"),
